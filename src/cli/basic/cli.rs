...
mod tests {
    ...
    fn test_reset_command_parsing() {
        let app = create_test_app();
        let matches = app
            .try_get_matches_from(["argos", "reset", "--component", "user"])
            .unwrap();
    ...
    fn test_reset_command_invalid_component() {
        let app = create_test_app();
        let matches = app
            .try_get_matches_from(["argos", "reset", "--component", "invalid"])
            .unwrap();
        let (name, sub_matches) = matches.subcommand().unwrap();
        assert_eq!(name, "reset");
        assert_eq!(
    ...
    fn test_view_command_parsing() {
        let app = create_test_app();
        let matches = app
            .try_get_matches_from(["argos", "view", "--component", "version"])
            .unwrap();
        let (name, sub_matches) = matches.subcommand().unwrap();
        assert_eq!(name, "view");
        assert_eq!(
    ...
    fn test_init_dir_command_parsing() {
        let app = create_test_app();
        let matches = app
            .try_get_matches_from(["argos", "init-dir", "--path", "/tmp/test"])
            .unwrap();
        let (name, sub_matches) = matches.subcommand().unwrap();
    ...
    fn test_delete_parquet_command_parsing() {
        let app = create_test_app();
        let matches = app
            .try_get_matches_from(["argos", "delete-parquet", "--file", "test.parquet"])
            .unwrap();
        let (name, sub_matches) = matches.subcommand().unwrap();
    ...
    fn test_node_command_parsing() {
        let app = create_test_app();
        let matches = app
            .try_get_matches_from(["argos", "node", "offline"])
            .unwrap();
        let (name, sub_matches) = matches.subcommand().unwrap();
        assert_eq!(name, "node");
    ...
    fn test_node_list_command() {
        let app = create_test_app();
        let matches = app
            .try_get_matches_from(["argos", "node", "list"])
            .unwrap();
        let (name, sub_matches) = matches.subcommand().unwrap();
        assert_eq!(name, "node");
    ...
    fn test_node_list_with_metrics() {
        let app = create_test_app();
        let matches = app
            .try_get_matches_from(["argos", "node", "list", "--metrics"])
            .unwrap();
        let (name, sub_matches) = matches.subcommand().unwrap();
        assert_eq!(name, "node");
        let (sub_name, sub_sub_matches) = sub_matches.subcommand().unwrap();
    ...
    fn test_sql_command_defaults() {
        let app = create_test_app();
        let matches = app
            .try_get_matches_from(["argos", "sql", "--execute", "SELECT * FROM logs"])
            .unwrap();
        let (name, sub_matches) = matches.subcommand().unwrap();
        assert_eq!(name, "sql");
    ...
    fn test_reset_index_updated_at_component_defaults() {
        let app = create_test_app();
        let matches = app
            .try_get_matches_from(["argos", "reset", "--component", "index-updated-at"])
            .unwrap();
        let (name, sub_matches) = matches.subcommand().unwrap();
        assert_eq!(name, "reset");
        assert_eq!(
    ...
    fn test_parse_id_command_parsing() {
        let app = create_test_app();
        let matches = app
            .try_get_matches_from(["argos", "parse-id", "--id", "123456789"])
            .unwrap();
        let (name, sub_matches) = matches.subcommand().unwrap();
    ...
    fn test_consistent_hash_single_file() {
        let app = create_test_app();
        let matches = app
            .try_get_matches_from(["argos", "consistent-hash", "--file", "file1.txt"])
            .unwrap();
        let (name, sub_matches) = matches.subcommand().unwrap();
        assert_eq!(name, "consistent-hash");
        let files: Vec<&String> = sub_matches.get_many::<String>("file").unwrap().collect();
    ...
    fn test_invalid_subcommand() {
        let app = create_test_app();
        let result = app.try_get_matches_from(["argos", "invalid-command"]);
    ...
    fn test_missing_required_argument() {
        let app = create_test_app();
        let result = app.try_get_matches_from(["argos", "migrate-meta"]);
        assert!(result.is_err());
    }
