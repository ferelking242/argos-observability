...
async fn main() -> Result<(), anyhow::Error> {
    ...
    if cfg.common.telemetry_enabled {
        tokio::task::spawn(async move {
            meta::telemetry::Telemetry::new()
                .send_track_event("Argos Observability - Starting server", None, true, false)
                .await;
        });
    }
    ...
    if cfg.common.telemetry_enabled {
        meta::telemetry::Telemetry::new()
            .send_track_event("Argos Observability - Server stopped", None, true, true)
            .await;
    }
...
mod tests {
    ...
    async fn test_telemetry_event_creation() {
        ...
        let event_name = "Argos Observability - Starting server";
        let stop_event = "Argos Observability - Server stopped";
