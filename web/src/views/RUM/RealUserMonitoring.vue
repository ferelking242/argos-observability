        ...
        <template #extra>
          <div class="flex items-center justify-center gap-2 flex-wrap">
            ...
            <EmptyStateIngestionChip
              icon="bolt"
              href="https://github.com/argos-observability/argos-observability/frontend-monitoring/#quick-implementation"
              data-test="rum-empty-quickstart-btn"
            >{{ t("rum.emptyState.quickImpl") }}</EmptyStateIngestionChip>
            <EmptyStateIngestionChip
              icon="menu-book"
              href="https://github.com/argos-observability/argos-observability/blog/frontend-monitoring-basics/"
