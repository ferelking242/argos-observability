            ...
            <img
              :src="
                store.state.theme == 'dark'
                  ? getImageURL('images/common/argos_logo_dark.svg')
                  : getImageURL('images/common/argos_logo.svg')
              "
        ...
        <div class="grid grid-cols-1 gap-4">
          ...
          <div class="bg-(--o2-card-bg) rounded-[0.625rem] p-4 flex flex-col gap-y-2">
            ...
            <div class="grid grid-cols-4 gap-2.5">
              <a
                href="https://github.com/argos-observability/argos-observability/blob/main/Cargo.toml"
                target="_blank"
              ...
              <a
                href="https://github.com/argos-observability/argos-observability/blob/main/web/package.json"
                target="_blank"
                class="flex items-center gap-3 py-3 px-3.5 border border-(--o2-border-color) rounded-lg bg-(--o2-card-bg) no-underline transition-all duration-200 hover:border-[color-mix(in_srgb,var(--o2-primary-color)_35%,transparent)]"
              >
          ...
          >
            ...
            <OText v-if="store.state.zoConfig.build_type == 'opensource'" variant="body" as="div" class="leading-relaxed m-0 mb-4">
              ...
              <a
                href="https://github.com/argos-observability/argos-observability/blob/main/LICENSE"
                target="_blank"
          ...
          <div v-else class="bg-(--o2-card-bg) rounded-[0.625rem] p-4">
            ...
            <div class="flex flex-wrap gap-2">
              <a
                href="https://github.com/argos-observability/argos-observability"
                target="_blank"
