    ...
    it("should navigate to docs with default URL", () => {
      const navigateToDocs = () => {
        ...
        if (config.isEnterprise === "true" && store.state.zoConfig.custom_docs_url) {
          ...
          window.open("https://github.com/argos-observability/argos-observability/wiki", "_blank");
        }
      };

      navigateToDocs();
      expect(mockWindow.open).toHaveBeenCalledWith("https://github.com/argos-observability/argos-observability/wiki", "_blank");
    });
