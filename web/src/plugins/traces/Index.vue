...
const onAskAiSetupTracing = () => {
  emit(
    "sendToAiChat",
    `I don't have any trace streams in Argos Observability yet and want to start sending traces. How do I instrument my services to send traces (e.g. via OpenTelemetry / OTLP)?`,
    false,
  );
};
