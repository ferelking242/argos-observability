...
describe("TrialPeriod.vue", () => {
  ...
  describe("redirectContactSupport method", () => {
    ...
    it("should open contact support URL in new tab", () => {
      ...
      expect(mockWindowOpen).toHaveBeenCalledWith("https://github.com/argos-observability/argos-observability/contactus/", "_blank");
    });
  ...
  describe("Additional Coverage Tests", () => {
    ...
    it("should display correct subtitle text", () => {
      ...
      const banner = wrapper.find('[data-test="trial-period-container"]');
      expect(banner.exists()).toBe(true);
      expect(banner.text()).toContain("Upgrade to a plan to continue enjoying the services by Argos Observability.");
    });
