...
<div class="flex h-screen">
  ...
  <div class="hidden lg:flex lg:w-[40%] bg-[url('@/assets/images/common/openobserve_banner_compreesed.png')] bg-cover bg-center bg-no-repeat">
    ...
    <div style="margin-bottom: 34px; margin-left: 32px;">
     <span style=" margin-bottom: 12px;"> <img style="height: 40px; margin-left: -1px;" src="@/assets/images/common/argos_logo.svg" alt="Argos Observability Logo" />
      </span>
      <div style="font-size: 24px; color: white; font-weight: 600; line-height:33px; margin-top: 5px; ">
        Try Argos Observability today for more efficient and performant observability.
      </div>
    </div>
  </div>
  </div>
  ...
  <div :class="[
    ...
    <div class="flex flex-col items-center mb-4">
      <img style="height: 64px;" src="@/assets/images/common/argos_argos_mini_logo.svg" alt="Get Started Banner" />
...
<div class="w-full flex justify-center">
  <div class="w-full max-w-[500px] flex flex-col items-center gap-y-2 px-4">
    ...
    >
      © Argos Observability <span id="year">{{ new Date().getFullYear() }}</span>
    </div>
  </div>
</div>
