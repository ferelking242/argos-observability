...
const editionList = computed((): EditionMeta[] => [
  {
    ...
    ctaUrl: buildType === 'opensource' ? null : 'https://github.com/argos-observability/argos-observability',
  },
  {
    id: 'enterprise',
    ...
    ctaUrl: buildType === 'enterprise' ? null : 'https://github.com/argos-observability/argos-observability/download',
  },
  {
    id: 'cloud',
    shortName: 'Cloud',
    ...
    ctaUrl: buildType === 'cloud' ? null : 'https://github.com/argos-observability/argos-observability',
  },
]);
