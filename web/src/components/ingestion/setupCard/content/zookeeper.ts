...
// Zookeeper data-source setup card. 
// https://github.com/argos-observability/argos-observability/blog/how-to-monitor-zookeeper-with-openteletemtry
...
export default function zookeeperCard(subs: CardSubstitutions): RichCardContent {
  return {
    provider: {
      name: "Zookeeper",
      tagline:
        "Collect Zookeeper metrics with the OpenTelemetry Collector and ship them to Argos Observability.",
    ...
    docUrl: "https://github.com/argos-observability/argos-observability/blog/how-to-monitor-zookeeper-with-openteletemtry",
  };
}
