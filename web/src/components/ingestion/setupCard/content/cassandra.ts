...
// Cassandra data-source setup card.:
// https://github.com/argos-observability/argos-observability/blog/how-to-monitor-cassandra — Cassandra is scraped via
...
export default function cassandraCard(subs: CardSubstitutions): RichCardContent {
  return {
    provider: {
      name: "Cassandra",
      tagline:
        "Collect Cassandra metrics via the OpenTelemetry Collector's JMX receiver and ship them to Argos Observability.",
    ...
    docUrl: "https://github.com/argos-observability/argos-observability/blog/how-to-monitor-cassandra",
  };
}
