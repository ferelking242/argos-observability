...
// Databricks data-source setup card. 
// https://github.com/argos-observability/argos-observability/blog/monitor-databricks/ — Databricks ships LOGS by
// POSTing them from a notebook to Argos Observability's logs API (no OTel collector).
...
export default function databricksCard(
  ...
  return {
    provider: {
      name: "Databricks",
      tagline:
        "Ship Databricks notebook logs to Argos Observability over the logs API.",
    ...
    steps: [
      {
        ...
        description:
          "Paste into a Databricks notebook cell — it POSTs records to Argos Observability logs API.",
      ...
      {
        id: "verify",
        title: "Verify Data in Argos Observability",
        description:
    ...
    docUrl: "https://github.com/argos-observability/argos-observability/blog/monitor-databricks/",
  };
}
