...
// Snowflake data-source setup card. 
// https://github.com/argos-observability/argos-observability/blog/how-to-monitor-snowflake-with-opentelemetry-receiver
...
export default function snowflakeCard(subs: CardSubstitutions): RichCardContent {
  return {
    provider: {
      name: "Snowflake",
      tagline:
        "Collect Snowflake account metrics with the OpenTelemetry Collector and ship them to Argos Observability.",
    ...
    steps: [
      ...
      },
      {
        ...
        description:
          "Hit Test below, or check Streams for the `snowflake_*` metrics.",
    ...
    docUrl: "https://github.com/argos-observability/argos-observability/blog/how-to-monitor-snowflake-with-opentelemetry-receiver",
  };
}
