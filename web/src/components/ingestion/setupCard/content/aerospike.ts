...
// Aerospike data-source setup card.:
// https://github.com/argos-observability/argos-observability/blog/how-to-monitor-aerospike-database (aerospike
...
export default function aerospikeCard(subs: CardSubstitutions): RichCardContent {
  return {
    provider: {
      name: "Aerospike",
      tagline:
        "Collect Aerospike metrics with the OpenTelemetry Collector and ship them to Argos Observability.",
    ...
    docUrl: "https://github.com/argos-observability/argos-observability/blog/how-to-monitor-aerospike-database",
  };
}
