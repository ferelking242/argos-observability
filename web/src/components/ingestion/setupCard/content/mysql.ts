...
// MySQL data-source setup card. 
// https://github.com/argos-observability/argos-observability/blog/monitor-mysql-metrics-otel (requires MySQL 8.0+).
...
export default function mysqlCard(subs: CardSubstitutions): RichCardContent {
  ...
  return {
    provider: {
      name: "MySQL",
      tagline:
        "Collect MySQL metrics with the OpenTelemetry Collector and ship them to Argos Observability.",
    ...
    docUrl: "https://github.com/argos-observability/argos-observability/blog/monitor-mysql-metrics-otel",
  };
}
