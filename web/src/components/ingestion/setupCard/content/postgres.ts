...
// specifics. 
// https://github.com/argos-observability/argos-observability/blog/how-to-monitor-postgresql-performance
...
export default function postgresCard(
  ...
  return {
    provider: {
      name: "Postgres",
      tagline:
        "Collect PostgreSQL metrics with the OpenTelemetry Collector and ship them to Argos Observability.",
    ...
    docUrl: "https://github.com/argos-observability/argos-observability/blog/how-to-monitor-postgresql-performance",
  };
}
