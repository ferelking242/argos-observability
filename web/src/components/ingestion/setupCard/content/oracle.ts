...
// Oracle DB data-source setup card. 
// https://github.com/argos-observability/argos-observability/wiki/integration/database/oracle/ (oracledb receiver).
...
export default function oracleCard(subs: CardSubstitutions): RichCardContent {
  return {
    provider: {
      name: "Oracle",
      tagline:
        "Collect Oracle DB metrics with the OpenTelemetry Collector and ship them to Argos Observability.",
    ...
    docUrl: "https://github.com/argos-observability/argos-observability/wiki/integration/database/oracle/",
  };
}
