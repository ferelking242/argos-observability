...
// streams land in Argos Observability. Reference: https://github.com/argos-observability/argos-observability/blog/monitor-sql-server-with-otel/
...
export default function sqlServerCard(
  ...
  return {
    provider: {
      name: "SQL Server",
      tagline:
        "Collect SQL Server metrics with the OpenTelemetry Collector and ship them to Argos Observability.",
    ...
    docUrl: "https://github.com/argos-observability/argos-observability/blog/monitor-sql-server-with-otel/",
  };
}
