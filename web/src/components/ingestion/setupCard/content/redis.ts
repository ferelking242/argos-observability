...
// Redis data-source setup card. 
// https://github.com/argos-observability/argos-observability/blog/monitor-redis-metrics-otel
...
export default function redisCard(subs: CardSubstitutions): RichCardContent {
  return {
    provider: {
      name: "Redis",
      tagline:
        "Collect Redis metrics with the OpenTelemetry Collector and ship them to Argos Observability.",
    ...
    docUrl: "https://github.com/argos-observability/argos-observability/blog/monitor-redis-metrics-otel",
  };
}
