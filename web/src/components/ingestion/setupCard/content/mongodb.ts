...
// MongoDB data-source setup card. 
// https://github.com/argos-observability/argos-observability/blog/monitor-mongodb-metrics-otel (requires MongoDB 4.0+).
...
export default function mongodbCard(subs: CardSubstitutions): RichCardContent {
  ...
  return {
    provider: {
      name: "MongoDB",
      tagline:
        "Collect MongoDB metrics with the OpenTelemetry Collector and ship them to Argos Observability.",
    ...
    docUrl: "https://github.com/argos-observability/argos-observability/blog/monitor-mongodb-metrics-otel",
  };
}
