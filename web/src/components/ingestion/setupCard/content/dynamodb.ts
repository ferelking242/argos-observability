...
// DynamoDB data-source setup card. 
// https://github.com/argos-observability/argos-observability/blog/how-to-monitor-dynamodb-table — DynamoDB item
// changes flow DynamoDB Streams → Kinesis Data Stream → Kinesis Firehose → the
// Argos Observability Firehose endpoint (an AWS-console flow; no OTel collector).
...
export default function dynamodbCard(
  ...
  return {
    provider: {
      name: "DynamoDB",
      tagline:
        "Stream DynamoDB item changes into Argos Observability via Kinesis Firehose.",
    ...
    steps: [
      {
        ...
        title: "Argos Observability Firehose Endpoint",
        description:
    ...
    docUrl: "https://github.com/argos-observability/argos-observability/blog/how-to-monitor-dynamodb-table",
  };
}
