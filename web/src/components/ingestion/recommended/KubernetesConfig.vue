      ...
      <div class="flex items-start gap-3">
        ...
        <div class="flex-1">
          ...
          <p class="text-sm mt-0 mb-6!" :class="descriptionClass">
            Install Argos collector with a single command. Just set your cluster name and run.
          </p>
          ...
          <div v-if="config.isCloud != 'true'" class="mb-3">
            <OTabs v-model="installType" dense>
              ...
              <OTab name="internal" label="Internal Endpoint">
                <OTooltip content="Use this if Argos Observability is in the same cluster" side="top" />
              </OTab>
            </OTabs>
          </div>
          ...
          <div class="mt-2 text-xs" :class="hintClass">
            ...
            This installs cert-manager, OpenTelemetry operator, and Argos collector automatically
          </div>
        </div>
      </div>
    </div>
...
Make changes accordingly to the above URL.
    ...
    <div class="text-base font-medium pl-1 mt-3 mb-4">
      Once you have installed the Argos collector, it will:
