...
describe('OtelConfig.vue', () => {
  ...
  describe('Utility Functions Integration', () => {
    ...
    it('should handle different ingestion URLs', () => {
      mockGetIngestionURL.mockReturnValue('https://api.argos-observability.io')
      mockGetEndPoint.mockReturnValue({
        url: 'https://api.argos-observability.io',
      ...
      wrapper = createWrapper()
      expect(mockGetEndPoint).toHaveBeenCalledWith('https://api.argos-observability.io')
    })
  })
