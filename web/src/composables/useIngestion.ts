...
const useIngestion = () => {
  ...
  const databaseDocURLs = {
    ...
    oracle: "https://github.com/argos-observability/argos-observability/wiki/integration/database/oracle/",
  };
...
Access Key: [BASIC_PASSCODE]`;
  ...
  const languagesDocURLs = {
    python:
      "https://github.com/argos-observability/argos-observability/blog/handling-errors-with-opentelemetry-python",
