...
/**
 * Record fields Argos Observability writes alongside the real Prometheus labels. They
    ...
    try {
      ...
      for (let attempt = 0; attempt < windows.length; attempt++) {
        ...
        try {
          ...
          // The endpoint returns every record field, which includes Argos Observability's
