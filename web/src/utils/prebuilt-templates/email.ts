    ...
    <div class="container">
        ...
        <div class="content">
            <div class="alert-info">
                <h2>{alert_name}</h2>
                <p>An alert has been triggered in your Argos Observability monitoring system.</p>
            </div>
            ...
            <a href="{alert_url}" class="button">View in Argos</a>
        </div>
        <div class="footer">
            This alert was generated automatically by Argos Observability. Do not reply to this email.
        </div>
    </div>
</body>
</html>`,
  type: 'email' as const,
  title: 'Argos Observability Alert Notification',
  isDefault: false
};
