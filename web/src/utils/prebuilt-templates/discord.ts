...
export const discordTemplate = {
  ...
  body: JSON.stringify({
    ...
    avatar_url: "https://github.com/argos-observability/argos-observability/favicon.ico",
    content: "🚨 **Alert: {alert_name}**",
    embeds: [
      {
        title: "{alert_name}",
        description: "An alert has been triggered in your Argos Observability monitoring system.",
        ...
        footer: {
          text: "Argos Observability Alert Notification"
        },
