...
export const awsIntegrations: AWSIntegration[] = [
  {
    ...
    documentationUrl: 'https://github.com/argos-observability/argos-observability/blog/what-is-aws-cloudtrail-and-how-to-monitor-cloudtrail-logs/',
    category: 'security',
    comingSoon: false,
  },
  {
  ...
  },
  {
    ...
    hasDashboard: false,
    documentationUrl: 'https://github.com/argos-observability/argos-observability/blog/how-to-monitor-all-aws-metrics-in-one-place/',
    category: 'metrics',
    comingSoon: false,
  },
  {
    ...
    componentOptions: [
      {
        ...
        description: 'Manually install Argos collector on Windows EC2 instances',
        component: 'WindowsConfig',
      },
      {
        name: 'Linux/Unix/MacOS (Manual Install)',
        description: 'Manually install Argos collector on Linux/Unix/MacOS EC2 instances',
  ...
  },
  {
    ...
    hasDashboard: false,
    documentationUrl: 'https://github.com/argos-observability/argos-observability/wiki/ingestion/logs/s3/',
    category: 'logs',
    comingSoon: false,
  },
  {
    ...
    cloudFormationTemplate: '',
    hasDashboard: false,
    documentationUrl: 'https://github.com/argos-observability/argos-observability/wiki/ingestion/logs/lambda/',
    category: 'logs',
    comingSoon: false,
  },
  {
  ...
  },
  {
    ...
    hasDashboard: true,
    dashboardGithubUrl: 'https://raw.githubusercontent.com/openobserve/dashboards/main/AWS%20Cloudfront%20Access%20Logs/Cloudfront_to_Argos Observability.dashboard.json',
